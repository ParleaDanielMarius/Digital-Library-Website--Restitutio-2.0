...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'last_name' => 'Nume',
        'title' => 'Titlu',
        'title_long' => 'Titlu Lung',
        'cover_path' => 'Cale Copertă',
        'pdf_path' => 'Cale PDF',
        'publisher' => 'Editură',
        'publisher_when' => 'Data Publicării',
        'publisher_day' => 'Ziua Publicării',
        'publisher_month' => 'Luna Publicării',
        'publisher_year' => 'Anul Publicării',
        'publisher_where' => 'Locul Publicării',
