...
<head>
    <!-- Title -->
    <title>Restitutio | BCU Carol I </title>
                    ...
                    <div class="site-navigation mr-auto d-none d-xl-block">
                        <ul class="nav">
                            <li class="nav-item dropdown">
                                <a id="homeDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-3 px-0 py-3 font-weight-medium d-flex align-items-center"
                                   aria-haspopup="true"
                                   aria-expanded="false"
                            ...
                            <li class="nav-item"><a href="{{route('items.index')}}" class="nav-link link-black-100 mx-3 px-0 py-3 font-weight-medium">All Items</a></li>
                            <li class="nav-item dropdown">
                                <a id="shopDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-3 px-0 py-3 font-weight-medium d-flex align-items-center"
                                   aria-haspopup="true"
                                   aria-expanded="false"
                                   data-unfold-event="hover"
                            ...
                            <li class="nav-item">
                                <a id="featuresDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-3 px-0 py-3 font-weight-medium d-flex align-items-center"
                                   aria-haspopup="true"
                                   aria-expanded="false"
                                   data-unfold-event="hover"
                            ...
                            <li class="nav-item dropdown">
                                <a id="blogDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-3 px-0 py-3 font-weight-medium d-flex align-items-center"
                                   aria-haspopup="true"
                                   aria-expanded="false"
                                   data-unfold-event="hover"
                            ...
                            <li class="nav-item dropdown">
                                <a id="pagesDropdownInvoker" href="#" class="dropdown-toggle nav-link link-black-100 mx-3 px-0 py-3 font-weight-medium d-flex align-items-center"
                                   aria-haspopup="true"
                                   aria-expanded="false"
                                   data-unfold-event="hover"
                    ...
                    <div class="d-none d-md-flex align-items-center mt-3 mt-md-0 ml-md-auto">
                        ...
                        <a href="mailto:info@bookworm.com" class="mr-4 mb-4 mb-md-0">
                            <div class="d-flex align-items-center text-dark font-size-2 text-lh-sm">
                                ...
                                <div class="ml-2">
                                    <span class="text-secondary-gray-1090 font-size-1">contact@bcub.ro</span>
                        ...
                        <a href="tel:+1246-345-0695">
                            <div class="d-flex align-items-center text-dark font-size-2 text-lh-sm">
                                ...
                                <div class="ml-2">
                                    <span class="text-secondary-gray-1090 font-size-1">+40 21 312 01 08</span>
                                    <div class="h6 mb-0">Contact</div>
                                </div>
                            </div>
                        </a>
                        <!-- End Customer care -->
        ...
        <div class="pb-5 space-bottom-lg-3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="pb-6 pb-lg-0">
                            ...
                            <div class="mb-4 h-white">
                                <a href="mailto:sale@bookworm.com" class="font-size-2 d-block text-gray-450 mb-1">contact@bcub.ro</a>
                                <a href="tel:+1246-345-0695" class="font-size-2 d-block text-gray-450">+40 21 312 01 08</a>
                            </div>
                            <ul class="list-unstyled mb-0 d-flex">
                                <li class="h-white btn pl-0">
                                    <a class="text-gray-450" href="https://www.instagram.com/bcu_bucuresti/">
                                        <span class="fab fa-instagram"></span>
                                    </a>
                                </li>
                                <li class="h-white btn">
                                    <a class="text-gray-450" href="https://www.facebook.com/BCUCaroII/">
                                        <span class="fab fa-facebook-f"></span>
                                    </a>
                                </li>
                                <li class="h-white btn">
                                    <a class="text-gray-450" href="https://www.youtube.com/user/BibliotecaCentrala/videos">
                    ...
                    <div class="col-lg-2">
                        <div class="mb-6 mb-lg-0">
                            <h4 class="font-size-3 font-weight-medium mb-2 mb-xl-5 pb-xl-1 text-white">Categories</h4>
                            <ul class="list-unstyled mb-0">
                                <li class="h-white pb-2">
                                    <a class="font-size-2 text-gray-450 widgets-hover transition-3d-hover" href="#">Action</a>
                                </li>
                                <li class="h-white py-2">
                                    <a class="font-size-2 text-gray-450 widgets-hover transition-3d-hover" href="#">Comedy</a>
                                </li>
                                <li class="h-white py-2">
                                    <a class="font-size-2 text-gray-450 widgets-hover transition-3d-hover" href="#">Drama</a>
                                </li>
                                <li class="h-white py-2">
                                    <a class="font-size-2 text-gray-450 widgets-hover transition-3d-hover" href="#">Horror</a>
                                </li>
                                <li class="h-white py-2">
                                    <a class="font-size-2 text-gray-450 widgets-hover transition-3d-hover" href="#">Kids</a>
                                </li>
                                <li class="h-white pt-2">
                                    <a class="font-size-2 text-gray-450 widgets-hover transition-3d-hover" href="#">Romantic Comedy</a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="space-1 border-top border-gray-710">
            <div class="container">
                <div class="d-md-flex text-center text-md-left justify-content-between align-items-center">
                    ...
                    <!-- Copyright -->
                    <p class="mb-3 mb-md-0 font-size-2 text-gray-450">© 2022 • BCU „Carol I” - All rights reserved.</p>
                    <!-- End Copyright -->
