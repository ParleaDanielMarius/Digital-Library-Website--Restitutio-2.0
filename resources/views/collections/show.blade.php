...
{{--                Collection Details (Admin Only) & Actions --}}
            @auth()
            ...
            <div class="container space-top-2 space-top-wd-3 px-3">
                <div class="row">
                    <div class="col-lg-4 col-wd-3 d-flex">
                        <img class="img-fluid mb-5 mb-lg-0 mt-auto" style="height: 100%; width: 100%" src="@if($collection->cover_path && file_exists('storage' . '/' . $collection->cover_path)){{asset('storage/' . $collection->cover_path)}} @else{{asset('assets/img/collections/no-collection-image.png')}}@endif" alt="Image-Description">
                    </div>
                    <div class="col-lg-8 col-wd-9">
                        <div class="mb-8">
                            <span class="text-gray-400 font-size-2">{{__('collections')["items_count"]}} {{$collection->items_count}}</span>
