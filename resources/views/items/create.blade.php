    ...
    <div class="page-header border-bottom">
        <div class="container">
            <div class="d-md-flex justify-content-between align-items-center py-4">
                <h1 class="page-title font-size-3 font-weight-medium m-0 text-lh-lg">Create Item</h1>
                ...
                <main id="main" class="site-main">
                    <article id="post-6" class="post-6 page type-page status-publish hentry">
                        <header class="entry-header space-top-2 space-bottom-1 mb-2">
                            <h4 class="entry-title font-size-7 text-center">Create Item</h4>
                        </header>
                                            ...
                                            <div class="woocommerce-billing-fields">
                                                ...
                                                <div class="woocommerce-billing-fields__field-wrapper row">
                                                    ...
                                                    <p class="col-12 mb-4d75 form-row form-row-wide address-field validate-required" id="publisher_when_field" data-priority="60" data-o_class="form-row form-row-wide address-field validate-required">
                                                        ...
                                                        <input type="text" class="input-text form-control" name="publisher_when" id="publisher_when" placeholder="Ex: 2004-10-07" value="{{old('publisher_when') ?? ''}}" autocomplete="publisher_when">
                                                    </p>
                                                    ...
                                                    <p class="col-12 mb-4d75 form-row form-row-wide" id="ISBN_field" data-priority="160" data-o_class="form-row form-row-wide">
                                                        ...
                                                        <input type="text" class="input-text form-control" value="{{old('ISBN') ?? ''}}" placeholder="Ex: 9780977476077" name="ISBN" id="ISBN" autocomplete="ISBN">
                                                    </p>
