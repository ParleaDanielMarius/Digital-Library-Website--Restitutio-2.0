                ...
                <div class="shop-control-bar d-lg-flex justify-content-between align-items-center mb-5 text-center text-md-left">
                    ...
                    <div class="shop-control-bar__right d-md-flex align-items-center">
                        <form action="" class="woocommerce-ordering mb-4 m-md-0" method="GET">
                            <!-- Select -->
                            <select class="js-select selectpicker dropdown-select orderby" name="sortBy"
                                    data-style="border-bottom shadow-none outline-none py-2">
                                <option value="latest">Sort by Latest</option>
                                <option value="SORT_ASC" selected="selected">Asc</option>
                                <option value="SORT_DESC">Desc</option>
                            </select>
                            <!-- End Select -->
                        </form>

                        <form action="" class="ml-md-4 mb-4 m-md-0 d-none d-xl-block" method="GET">
                            <!-- Select -->
