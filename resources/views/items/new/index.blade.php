        ...
        <div class="row">
            <div id="primary" class="content-area order-2">
                ...
                <div class="shop-control-bar d-lg-flex justify-content-between align-items-center mb-5 text-center text-md-left">
                    ...
                    <div class="shop-control-bar__right d-md-flex align-items-center">
                            ...
                            <!-- Select -->
                            <select id="sort_select" class="js-select selectpicker dropdown-select orderby"
                                    data-style="border-bottom shadow-none outline-none py-2">
                                <option value="latest">{{__('sort')['latest']}}</option>
                                <option value="asc" selected>{{__('sort')['asc']}}</option>
                                <option value="desc">{{__('sort')['desc']}}</option>
                            </select>
                            <!-- End Select -->
            ...
            <div id="secondary" class="sidebar widget-area order-1" role="complementary">
                <div id="widgetAccordion">
                    ...
                    <div id="Year" class="widget widget_search widget_author p-4d875 border">
                    ...
                    <div id="Month" class="widget widget_search widget_author p-4d875 border">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $('#sort_select').on('change', function() {
                sort_select = $(this).val()
                console.log(sort_select)
                fetch_data()
            });

        function fetch_data() {
            var url = 'items-index-get?sortBy='+sort_select+"&orderBy="+show_select
            $.ajax({
                url: url,
                type: 'GET',
                dataType: 'json',
